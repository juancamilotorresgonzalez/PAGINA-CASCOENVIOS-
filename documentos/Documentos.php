...
if (isset($_POST['consulta'])) {
    ...
    $query = "select * from documentos where numeroDocumento like
        '%$obj->numeroDocumento%' ";
                ...
                <form action="" name="documentos" method="POST">
                    <table width="500">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="numeroDocumento" id="numeroDocumento" placeholder="Digite el codigo del Documento" size="50">
                            </td>
                            <td>
